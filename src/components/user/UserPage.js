    ...
    <>
      {quizLists.length !== 0 ? (
        ...
        >
          ...
          <QuizCard name={quiz.name} tag={quiz.tag} id={quiz.id} user={quiz.users?(quiz.users[user]?quiz.users[user]:{}):{}} score={quiz.users?(quiz.users[user]?quiz.users[user].score:0):0} q={quiz.questions}  ></QuizCard>)}
